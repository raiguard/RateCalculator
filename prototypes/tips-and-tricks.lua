data:extend({
  ...
  {
    type = "tips-and-tricks-item",
    name = "rcalc-gui-search",
    category = "RateCalculator",
    order = "g",
    indent = 1,
    dependencies = { "rcalc-introduction" },
    trigger = { type = "dependencies-met" },
    image = "__RateCalculator__/graphics/tips-and-tricks/gui-search.png",
  },
  {
    type = "tips-and-tricks-item",
    name = "rcalc-gui-history",
    category = "RateCalculator",
    order = "h",
    indent = 1,
    dependencies = { "rcalc-introduction" },
    trigger = { type = "dependencies-met" },
    image = "__RateCalculator__/graphics/tips-and-tricks/gui-history.png",
  },
  {
    type = "tips-and-tricks-item",
    name = "rcalc-gui-temperatures",
    category = "RateCalculator",
    order = "i",
    indent = 1,
    dependencies = { "rcalc-introduction" },
    trigger = { type = "dependencies-met" },
    image = "__RateCalculator__/graphics/tips-and-tricks/gui-temperatures.png",
  },
  {
    type = "tips-and-tricks-item",
